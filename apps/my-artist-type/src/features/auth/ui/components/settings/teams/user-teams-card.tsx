...
import { userTeamsAtom, setActiveTeamAtom } from "../../../../client/atoms/organization.atoms.js";
	...
	return (
		<Card>
			<Card.Header>
				...
				<Card.Description>
					Teams you're a member of across all organizations. Set your active team to switch contexts.
				</Card.Description>
			</Card.Header>
			<Card.Content>
				{loading ? (
					...
					<div className="text-center py-8 text-muted-foreground">
						...
						<p className="text-sm mt-1">Join a team to collaborate with others.</p>
					</div>
				) : (

...
import { getDOMRangeRect } from '@components/markdown-editor/utils/get-dom-range-rect';
import { getSelectedNode } from '@components/markdown-editor/utils/get-selected-node';
import { setFloatingElemPosition } from '@components/markdown-editor/utils/set-floating-elem-position';
import { Separator } from '@shadcn/components/ui/separator';
import { ToggleGroup } from '@shadcn/components/ui/toggle-group';
      ...
      {editor.isEditable() && (
        <>
          ...
          >
            ...
            <ToggleGroup.Item value="link" aria-label="Toggle link" onClick={insertLink} size="sm">

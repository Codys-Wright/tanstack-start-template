...
export const themeNameAtom = createSyncedAtom('vite-ui-theme-name', 'neutral', validateThemeName);

// Radius atom
export const radiusAtom = createSyncedAtom('vite-ui-radius', 'default', validateRadius);

// Color mode atom
export const colorModeAtom = createSyncedAtom('vite-ui-theme', 'system', validateColorMode);

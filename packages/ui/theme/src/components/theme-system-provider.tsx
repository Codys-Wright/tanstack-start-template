...
export function ThemeSystemProviderWithContext({
  ...
  return (
    <ThemeSystemContext.Provider value={{ themeName, setThemeName, radius, setRadius }}>
      <ThemeSystemProvider themeName={themeName} radius={radius}>
        {children}
      </ThemeSystemProvider>
...
export function useThemeSystem() {
  ...
  if (context === undefined) {
    throw new Error('useThemeSystem must be used within a ThemeSystemProviderWithContext');
  }
  return context;
}

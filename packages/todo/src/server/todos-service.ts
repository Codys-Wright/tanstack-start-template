...
import { TodosRepository } from "../database/todos-repository";
import type {
  CreateTodoInput,
  TodoId,
  UpdateTodoInput,
...
export class TodosService extends Effect.Service<TodosService>()(
  "TodosService",
  {
    dependencies: [TodosRepository.Default],
    effect: Effect.gen(function* () {
      ...
      return {
        ...
        update: (userId: UserId, id: TodoId, input: UpdateTodoInput) => repo.update(userId, id, input),

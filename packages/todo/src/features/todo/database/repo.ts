  ...
  '@todo/database/TodoRepository',
  {
    ...
    effect: Effect.gen(function* () {
      ...
      const list = flow(
        ...
        Effect.orDie,
        Effect.withSpan('TodoRepository.list'),
      );
      ...
      const getById = flow(
        ...
        Effect.flatMap(
          Option.match({
            onNone: () => Effect.fail(new TodoNotFound({ id: '' as TodoId })),
            onSome: Effect.succeed,
          }),
        ),
        Effect.orDie,
        Effect.withSpan('TodoRepository.getById'),
      );
      ...
      const create = flow(
        ...
        Effect.orDie,
        Effect.withSpan('TodoRepository.create'),
      );
      ...
      const update = (userId: UserId, id: TodoId, input: UpdateTodoInput) =>
        ...
        }).pipe(Effect.orDie, Effect.withSpan('TodoRepository.update'));
      ...
      const remove = flow(
        ...
        Effect.orDie,
        Effect.withSpan('TodoRepository.remove'),
      );

...
/**
 * Creates a layer that applies a SQL schema dump file for testing.
 * @param schemaPath - Absolute path to the schema SQL file
 */
export const makeApplySchemaDump = (schemaPath: string) =>
  Layer.effectDiscard(
    Effect.gen(function* () {
...
/**
 * Creates a PgClient test layer with schema dump applied.
 * @param schemaPath - Absolute path to the schema SQL file
 */

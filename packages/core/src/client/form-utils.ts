...
type RootErrorKey = '';
type SchemaValidatorResult<SchemaInput extends Record<PropertyKey, unknown>> = Partial<
  Record<Paths<SchemaInput> | RootErrorKey, string>
> | null;

export type SchemaValidatorFn<SchemaInput extends Record<PropertyKey, unknown>> = (submission: {
  value: SchemaInput;
}) => SchemaValidatorResult<SchemaInput>;

export const validateWithSchema =
  <A, I extends Record<PropertyKey, unknown>>(schema: Schema.Schema<A, I>): SchemaValidatorFn<I> =>
...
export const makeFormOptions = <
  SchemaA,
  SchemaI extends Record<PropertyKey, unknown>,

...
import { UserTeamsCard } from '@auth/features/team/client/presentation/components/user-teams-card';
import { ApiKeysCard } from './api-keys-card';
import { OrganizationsCard } from '@auth/features/organization/client/presentation/components/organizations-card';
import { UserInvitationsCard } from '@auth/features/invitation/ui/user-invitations-card';
import { TeamsCard } from '@auth/features/team/client/presentation/components/teams-card';
    ...
    <div className={`flex w-full grow flex-col gap-4 md:flex-row md:gap-12 ${className || ''}`}>
      ...
      <div className="flex justify-between gap-2 md:hidden">
        ...
        <Drawer>
          ...
          <Drawer.Content>
            <Drawer.Header>
              <Drawer.Title className="hidden">Account Settings</Drawer.Title>
            </Drawer.Header>

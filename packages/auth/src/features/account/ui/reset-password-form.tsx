...
import { resetPasswordAtom } from '@auth/features/session/client/atoms';
...
export function ResetPasswordForm({ className }: ResetPasswordFormProps) {
  const search = useSearch({ from: '/auth/$authView' }) as Record<string, string> | undefined;
  ...
  const isLoading = Result.isInitial(resetPasswordResult) && resetPasswordResult.waiting;

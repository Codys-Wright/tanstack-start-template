        ...
        <Card.Header>
          <div className="flex items-center justify-between">
            <div>
              ...
              <Card.Description>Manage teams within your organization.</Card.Description>
            </div>
            <CreateTeamDialog>
              <Button size="sm" className="gap-2" disabled={!permissions.canCreate || !activeOrgId}>
        ...
        <Card.Content>
          {!activeOrgId ? (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm mt-1">Switch to an organization above to manage teams.</p>
            </div>
          ) : isPending ? (

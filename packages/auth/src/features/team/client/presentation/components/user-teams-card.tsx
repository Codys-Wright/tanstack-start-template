...
import { userTeamsAtom, setActiveTeamAtom } from '@auth/features/team/client/atoms.js';
  ...
  return (
    <Card>
      <Card.Header>
        ...
        <Card.Description>
          Teams you're a member of across all organizations. Set your active team to switch
          contexts.
        </Card.Description>
      </Card.Header>
      <Card.Content>
